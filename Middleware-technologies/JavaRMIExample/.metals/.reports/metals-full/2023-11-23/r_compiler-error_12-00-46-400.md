...
public class ServerMain {
    ...
    public static void main(String[] args) {
        try {
            ...
            Registry registry = LocateRegistry.createRegistry(5555);    //in middleware tech we need a standard trusted third party we trust that maps the Server names, and client goes to find it
