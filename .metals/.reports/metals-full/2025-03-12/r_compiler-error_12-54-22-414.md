file://<WORKSPACE>/src/document-service/src/main/java/com/docprocessing/document/sercurity/SupabaseJwtService.java
...
action parameters:
uri: file://<WORKSPACE>/src/document-service/src/main/java/com/docprocessing/document/sercurity/SupabaseJwtService.java
text:
```scala
package com.docprocessing.document.sercurity;

public package com.docprocessing.document.security;
