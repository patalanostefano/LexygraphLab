file://<WORKSPACE>/src/document-service/services/main/java/com/lexygraphai/document/dto/ProcessRequestDto.java
...
action parameters:
uri: file://<WORKSPACE>/src/document-service/services/main/java/com/lexygraphai/document/dto/ProcessRequestDto.java
text:
```scala
