file://<WORKSPACE>/src/document-service/src/main/java/com/docprocessing/document/service/FileSystemStorageService.java
...
action parameters:
uri: file://<WORKSPACE>/src/document-service/src/main/java/com/docprocessing/document/service/FileSystemStorageService.java
text:
```scala
