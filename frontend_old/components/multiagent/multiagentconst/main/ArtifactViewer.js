  ...
  useEffect(() => {
    const loadDocumentContent = async () => {
      ...
      if (!isGeneratedDocument(artifact)) {
        console.log(
          "Artifact non è un documento generato, non verrà mostrato nell'ArtifactViewer",
        );
        setContent('');
        return;
      }
      ...
      try {
        ...
        console.error(
          `Errore durante il caricamento del documento generato ${artifact.id}:`,
          error,
        );
    ...
    return (
      ...
      >
        ...
        <Typography
          ...
          sx={{ textAlign: 'center', fontSize: '1.05rem', mb: 1 }}
        >
    ...
    >
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', flex: 1 }}>
          ...
          <Typography
            variant="subtitle1"
            sx={{ ml: 1, fontWeight: 600, fontSize: '1.05rem' }}
          >
            {artifact.name}
          </Typography>
          {getGenerationBadge()}
          ...
          >
            {content ? (
              <Typography
                ...
                sx={{
                  whiteSpace: 'pre-wrap',
                  fontFamily: artifact.type?.includes('document')
                    ? "'Calibri', sans-serif"
                    : 'inherit',
                  fontSize: '1.05rem',
                  lineHeight: 1.5,
