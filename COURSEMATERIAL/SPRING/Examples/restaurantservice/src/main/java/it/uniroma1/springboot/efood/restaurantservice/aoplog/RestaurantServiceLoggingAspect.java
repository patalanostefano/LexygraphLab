package it.uniroma1.springboot.efood.restaurantservice.aoplog;
...
public class RestaurantServiceLoggingAspect {
    ...
    @Pointcut("execution(public * it.uniroma1.springboot.efood.restaurantservice.domain.RestaurantService.*(..))")
    public void restaurantServiceMethods() {}

    @Pointcut("execution(public void it.uniroma1.springboot.efood.restaurantservice.domain.RestaurantService.*(..))")
