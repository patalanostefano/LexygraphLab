...
class App extends Component {
    ...
    analyzeSentence() {
        fetch('INSERT_ADDRESS_MINIKUBE_SERVICE_WEBAPP_LB/sentiment', {
            method: 'POST',
            headers: {
            ...
            <MuiThemeProvider>
                <div className="centerize">
                    <Paper zDepth={1} className="content">
                        ...
                        <RaisedButton  label="Send" backgroundColor="green" style={style} onClick={this.analyzeSentence.bind(this)}/>
                        {polarityComponent}
                    </Paper>
                </div>
            </MuiThemeProvider>
